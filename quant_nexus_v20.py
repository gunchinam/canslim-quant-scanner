...
class QuantNexusApp:
    ...
    KR_NAMES: dict[str, str] = {
        ...
        "004690.KS": "삼천리",                       "005030.KS": "부산주공",  # 부산가스는 015350
        ...
        self.kr_sectors = {
            ...
            "🔬 반도체": {
                ...
                "반도체장비·소재":    [                                       "005290.KQ","014680.KS",
                                       ...
                                       "083450.KQ","170920.KQ","327260.KQ"],  # GST(테스트소켓), 엘티씨(반도체부품), RF머트리얼즈(RF소재)
            ...
            "🤖 AI 인프라": {
                ...
                "온디바이스AI":       [                                       "052710.KQ","054450.KQ",
                                       "323280.KQ","377480.KQ",
                                       "405100.KQ","432720.KQ",
                                       "066570.KS","011070.KS"],  # LG전자(AI가전·전장), LG이노텍(아이폰AI 카메라모듈)
            ...
            "🧬 바이오·헬스케어": {
                ...
                "바이오 신약":        [                                       "000100.KS","028300.KQ",
                                       ...
                                       "196170.KQ","207940.KS",
                                       "298380.KQ","326030.KS",
                                       "069620.KS","003090.KS","086450.KQ",
                                       "145020.KQ",
                                       "086900.KQ","008930.KS","102710.KQ","092040.KQ"],  # 대웅제약·대웅·동국제약·휴젤, 메디톡스·한미사이언스·이연제약·아미코젠 (091990 셀트리온헬스 합병, 196300 잘못된 매칭 제외)
            ...
            "🦾 로봇·자동화": {
                ...
                "자율주행·전장":      [                                       "000270.KS","005380.KS",
                                       "009150.KS","011070.KS",
                                       "012330.KS","307950.KS","051360.KQ"],  # 삼성전기(전장MLCC), LG이노텍(전장카메라), 토비스(차량용 디스플레이)
            },
            ...
            "🏢 지주사·종합상사": {
                ...
                "대형 지주사":        [                                       "003550.KS","034730.KS",
                                       "078930.KS","004800.KS",
                                       "004990.KS","180640.KS",
                                       "028260.KS"],              # LG, SK, GS, 효성, 롯데지주, 한진칼, 삼성물산

                # 종합상사·무역
                "종합상사·무역":      [                                       "047050.KS","001120.KS",
                                       "001740.KS"],              # 포스코인터내셔널, LX인터내셔널, SK네트웍스
            },

            # ── 22. 정유·에너지 ──────────────────────────────────────────────
            "⛽ 정유·에너지": {
                # 정유사
                "정유":               [                                       "010950.KS","096770.KS"],  # S-Oil, SK이노베이션
            },

            # ── 24. 건설기계·중공업 ──────────────────────────────────────────
            "🏗️ 건설기계·중공업": {
                # 굴착기·건설장비
                "건설기계":           [                                       "267270.KS"],  # HD현대건설기계
            },

            # ── 23. 바이오 CDMO ──────────────────────────────────────────────
            "💉 바이오 CDMO": {
                # CDMO·위탁생산 전문
                "CDMO 전문":          [                                       "950210.KS"],  # 프레스티지바이오파마
            },
        }
        self.eu_sectors = {
            # ── 1. 럭셔리·자동차 ──────────────────────────────────────────────
